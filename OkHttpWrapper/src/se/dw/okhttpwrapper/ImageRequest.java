...
public class ImageRequest {
	private static ImageRequest imageDownloader = null;
	private static int maxImageWidth = 300;
	private static int maxImageHeight = 300;
	private static DiskLruImageCache fileCache = null;
	
	public static ImageRequest initiateWDiskCache(Context context, int inMaxImageWidth, int inMaxImageHeight, int cacheSize) {
		maxImageWidth = inMaxImageWidth;
	...
	public static ImageRequest getInstance(){
		if(imageDownloader == null){
			imageDownloader = new ImageRequest();
			imageDownloader.setMode(ImageRequest.Mode.CORRECT);
		}
    ...
    public enum Mode { NO_ASYNC_TASK, CORRECT }
    ...
    /**
     * Mode.NO_ASYNC_TASK = Not async, generates NetworkOnMainThreadExc.
     * Mode.CORRECT = Async
     * @param mode N
     */
    ...
    private final HashMap<String, Bitmap> sHardBitmapCache =
        new LinkedHashMap<String, Bitmap>(HARD_CACHE_CAPACITY / 2, 0.75f, true) {
			...
			private static final long serialVersionUID = 4051027005566473991L;
    ...
    private void addBitmapToCache(String url, Bitmap bitmap) {
        if (bitmap != null) {
          ...
          //Then cache to file...TODO
            addToFileCache(url, bitmap);
        }
    }
    ...
    private Bitmap getBitmapFromCache(String url) {
        ...
        //Then try from file...TODO
        Bitmap fromFile = getFromFileCache(url);
        if(fromFile != null){
        	return fromFile;
        }
     ...
     * From file
     */
    private void addToFileCache(String url, Bitmap bitmap) {
    	if(fileCache != null){
    		fileCache.put(fileCache.generateKeyFromURL(url), bitmap);
    	}
    }
    private Bitmap getFromFileCache(String url){
    	if(fileCache != null){
    		return fileCache.getBitmap(fileCache.generateKeyFromURL(url));
    	}
    	return null;
    }
